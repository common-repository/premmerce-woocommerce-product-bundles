...
<div data-premmerce-bundle-form>
    ...
    <input type="hidden" data-msg-main-products value="<?php _e('Main product required', ProductBundlesPlugin::DOMAIN); ?>">
    <input type="hidden" data-msg-attached-products value="<?php _e('Attached products required', ProductBundlesPlugin::DOMAIN); ?>">

    <div class="product-table-wrap form-field form-required">
        <table data-table="new_bundle_products" class="products-table widefat">
            <thead>
            <tr>
    ...
    <p class="form-field form-required">
        ...
        <input class="checkbox" id="enable-checkbox" type="checkbox" name="active" checked>
